...
export default function CanadaPage() {
  ...
  const countrySchema = {
    ...
    "@type": "CollectionPage",
    "name": "Saunas in Canada",
    "description": "Find the best saunas in Canada. Browse Finnish, infrared, and steam saunas with ratings and reviews.",
    "mainEntity": {
      "@type": "ItemList",
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <SchemaMarkup schema={countrySchema} />
            ...
            <section className="bg-white py-2">
              <div className="container px-4 md:px-6 max-w-7xl mx-auto">
                ...
                <p className="text-xl max-w-3xl text-gray-600 mb-8">
                  Discover {saunas.length} sauna{saunas.length !== 1 ? 's' : ''} across Canada.
                </p>
              </div>
            </section>
            ...
            <section className="py-12 bg-secondary">
              <div className="container px-4 md:px-6 max-w-7xl mx-auto">
                <h2 className="text-2xl font-bold mb-6 text-white">
                  Top Saunas in <span className="text-primary">Canada</span>
                </h2>
