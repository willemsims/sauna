...
const SaunaCard = ({ sauna }) => {
  ...
  // Define category icons with their labels
  const categoryIcons = [
    {
      id: 'traditional',
      label: 'Traditional',
    ...
    },
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
          ...
          <path d="M12 15.75a.75.75 0 01.75.75v2.25a.75.75 0 01-1.5 0v-2.25a.75.75 0 01.75-.75z" />
        </svg>
      )
    },
    {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden">
      ...
      <div className="relative h-48 w-full">
        <Image
          src={sauna.photoUrl || 'https://images.pexels.com/photos/9638304/pexels-photo-9638304.jpeg'}
          alt={sauna.name}
          fill
      ...
      <div className="p-4">
        ...
        <div className="flex items-center mb-2">
          ...
          {sauna.reviewCount && (
            <span className="text-gray-light text-sm ml-1">
              ({sauna.reviewCount} reviews)
            </span>
          )}
        </div>
        ...
        <div className="flex flex-wrap gap-2 mb-3">
          {categoryIcons.map(category => (
            sauna[category.id] === 'Y' && (
              <div 
                key={category.id} 
                className="flex items-center justify-center bg-gray-100 rounded-full p-1.5 text-gray-700"
        ...
        {/* Contact Info */}
        <p className="text-sm text-gray-600 mb-3">{sauna.address}</p>
        {sauna.phone && (
